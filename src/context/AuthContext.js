...
export const AuthProvider = ({children}) => {
    ...
    const loginUser = async(e ) => {
        ...
        const response = await fetch('https://django-api.up.railway.app/account/token/',{
                method:"POST",
    ...
    const refresh_token = async(e) => {
        const response = await fetch('https://django-api.up.railway.app/account/token/refresh/',{
                    method:"POST",
                    headers:{'Content-Type':'application/json',},
